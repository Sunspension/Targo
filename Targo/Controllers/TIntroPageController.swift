...
class TIntroPageController : UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func viewControllerAtIndex(_ index: Int) -> UIViewController? {
        ...
        if let controller = self.instantiateViewControllerWithIdentifierOrNibName("IntroImageController") as? TIntroImageViewController {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        ...
        if let controller = viewController as? TIntroImageViewController , controller.imageName != nil {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
        ...
        if let controller = viewControllers!.last as? TIntroImageViewController , controller.imageName != nil {
    ...
    func pageViewController(_ pageViewController: UIPageViewController,
        ...
        if let controller = viewControllers!.first as? TIntroImageViewController {
